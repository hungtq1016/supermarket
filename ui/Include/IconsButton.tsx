    ...
    return(
        <>
            <div className="md:flex gap-x-6">
                ...
                <div className="flex gap-x-12 md:gap-x-4 items-center justify-center fixed md:relative bottom-0 inset-x-0 bg-white z-10 py-4 shadow-t md:shadow-none md:p-0 md:m-0">
                    <CartIcon/>
                    ...
                    {/* <Link href={'/member/wishlist'} className="md:-order-1">
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={"1.5"} stroke="currentColor" className="w-6 h-6">
